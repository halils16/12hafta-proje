...
public class BuildingPlacement : MonoBehaviour
{
    ...
    void Bulldozer()
    {
        Building buildinToDestroy = City.instance.buildings.Find(x => x.transform.position == curIndicatorPos);
        if (buildinToDestroy!=null)
        {
            City.instance.OnRemoveBuilding(buildinToDestroy);
        }
    }
